...
class ProcessingState(str, Enum):
    ...
    Order: PENDING → OCR_DONE → SCHEMA_REVIEW (if suggestions) → SCHEMA_ANALYSIS_DONE → CORRESPONDENT_DONE → DOCUMENT_TYPE_DONE → TITLE_DONE → TAGS_DONE → CUSTOM_FIELDS_DONE → PROCESSED
    """

    PENDING = "pending"
    OCR_DONE = "ocr_done"
    SCHEMA_REVIEW = "schema_review"  # Parked for schema review (new entities)
    ...
    TAGS_DONE = "tags_done"
    CUSTOM_FIELDS_DONE = "custom_fields_done"
    PROCESSED = "processed"
